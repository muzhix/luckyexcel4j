...
/** Object 通用类, 从{@code org.springframework.util.ObjectUtils}复制而来 */
public abstract class ObjectUtil {
   ...
   * @see net.hanbd.finoio.core.util.StringUtil#hasLength(CharSequence)
   * @see net.hanbd.finoio.core.util.StringUtil#isEmpty(Object)
